...
const ICON_WORD = '<svg viewBox="0 0 24 24" fill="none" stroke="#1565c0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><text x="12" y="17" text-anchor="middle" font-size="5" fill="#1565c0" stroke="none" font-weight="bold">DOC</text></svg>';
...
function showIndex() {
    ...
    document.title = "Teaching Syllabi - Mark Veltzer";
    window.scrollTo(0, 0);
}
...
function showSyllabus(path) {
    ...
    fetch(path)
        ...
        .then(function(html) {
            ...
            if (entry) document.title = entry.title + " - Teaching Syllabi";
            window.scrollTo(0, 0);
        })
