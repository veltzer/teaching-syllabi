...
## Outline
<!-- chapter: introduction-to-github-actions-and-workflows, duration: 1h -->
...
<!-- chapter: events-and-triggers, duration: 1h -->
* Events and Triggers
...
<!-- chapter: actions-and-marketplace, duration: 1h -->
...
<!-- chapter: environment-management, duration: 1h -->
...
<!-- chapter: advanced-workflow-features, duration: 1h -->
...
<!-- chapter: custom-actions-development, duration: 1h -->
...
<!-- chapter: best-practices-and-optimization, duration: 1h -->
