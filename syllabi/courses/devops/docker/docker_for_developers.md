...
## Outline
<!-- chapter: docker-theory, duration: 6h -->
* `Docker` Theory
    * What is `Docker`?
    * `Docker` benefits
        * Determinism
        ...
        * Application store
    * `Docker` tools
<!-- chapter: docker-under-the-hood, duration: 1h -->
* `Docker` under the hood
    * How virtual machines work
    * Containers vs virtual machines
    * The `Docker` Architecture
    * The `Docker` Engine
<!-- chapter: starting-out, duration: 1h -->
* Starting out
    * Installing `docker`
    * Running your first container
    * `Docker` concepts: Image vs Container
    * `Docker HUB`
<!-- chapter: creating-your-own-docker-images, duration: 1h -->
* Creating your own `docker` images
    * The `Dockerfile`
    * Creating your first image
    * Running your image
<!-- chapter: crafting-your-image, duration: 1h -->
* Crafting your image
    * The `Dockerfile` language.
    * The various keywords then their meaning.
<!-- chapter: dead-containers, duration: 1h -->
* Dead containers
    * How to see them
    * How to see their logs
    * How to revive/restart them
<!-- chapter: handling-logs, duration: 1h -->
* Handling logs
    * Log handlers in `Docker`
    * Writing your application correctly
<!-- chapter: networking-with-docker, duration: 1h -->
* Networking with `Docker`
    * Opening ports
    * Network devices
<!-- chapter: docker-and-volumes, duration: 2h -->
* `Docker` and Volumes
...
<!-- chapter: troubleshooting-and-debugging, duration: 3h -->
