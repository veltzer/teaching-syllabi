...
## Outline
<!-- chapter: docker-internals-and-architecture, duration: 2h -->
...
<!-- chapter: advanced-dockerfile-techniques-and-image-optimization, duration: 2h -->
...
<!-- chapter: docker-networking-in-depth, duration: 2h -->
...
<!-- chapter: advanced-docker-storage-and-volumes, duration: 3h -->
...
<!-- chapter: docker-in-production, duration: 4h -->
