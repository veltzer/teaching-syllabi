...
## Outline
<!-- chapter: multi-core-microcontroller-architectures, duration: 1h -->
...
<!-- chapter: memory-architecture-and-layouts, duration: 1h -->
...
<!-- chapter: cache-coherency-and-memory-ordering, duration: 1h -->
...
<!-- chapter: inter-core-communication-message-queues, duration: 2h -->
...
<!-- chapter: threading-models-and-rtos-integration, duration: 1h -->
...
<!-- chapter: interrupts-in-a-multi-core-environment, duration: 1h -->
...
<!-- chapter: shared-peripheral-access, duration: 1h -->
...
<!-- chapter: memory-mapped-communication-patterns, duration: 1h -->
...
<!-- chapter: debugging-and-profiling-multi-core-firmware, duration: 1h -->
...
<!-- chapter: real-time-and-safety-considerations, duration: 2h -->
