...
audience:
  ...
  - audiences:devops
---
<!-- course: linux_monitoring_tuning_debugging -->
# `Linux` Monitoring Tuning and Debugging

## Description
This course is intended for developers who wish to monitor or debug
...
## Outline
<!-- chapter: kernel-introduction-advanced-chapter-only-for-developers-not-for-qa-people, duration: 2h -->
...
<!-- chapter: monitoring-tuning-debugging-theory, duration: 1h -->
...
<!-- chapter: monitoring-processes, duration: 3h -->
...
<!-- chapter: monitoring-system-memory, duration: 2h -->
...
<!-- chapter: monitoring-cpu, duration: 2h -->
* Monitoring `cpu`
...
<!-- chapter: monitoring-disk, duration: 3h -->
* Monitoring disk
    * The mount paradigm
...
<!-- chapter: monitoring-network, duration: 3h -->
* Monitoring network
...
<!-- chapter: monitoring-the-kernel-advanced, duration: 3h -->
* Monitoring the kernel (advanced)
    ...
    * `udev` + demo of `udev`.
    * getting hardware info: lspci, lsusb, dmidecode, ...
<!-- chapter: the-boot-process-advanced, duration: 2h -->
...
<!-- chapter: embedded-linux-systems-advanced, duration: 1h -->
* Embedded `Linux` systems (advanced)
    ...
    * `BusyBox`
    * `libc` replacements
<!-- chapter: rpc-advanced, duration: 2h -->
* RPC (advanced)
    * basics
    * portmapper
    * rpcgen
