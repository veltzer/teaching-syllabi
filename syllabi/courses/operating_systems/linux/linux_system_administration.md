...
## Outline
<!-- chapter: core-system-architecture, duration: 4h -->
...
<!-- chapter: package-management-deep-dive, duration: 4h -->
...
<!-- chapter: storage-management-and-file-systems, duration: 3h -->
...
<!-- chapter: user-management-and-system-security, duration: 5h -->
...
<!-- chapter: network-services-and-configuration, duration: 4h -->
...
<!-- chapter: lvm-and-raid-optional, duration: 3h -->
...
<!-- chapter: selinux-apparmor-optional, duration: 2h -->
...
<!-- chapter: dns-server-administration-optional, duration: 2h -->
...
<!-- chapter: wireshark-network-analysis-optional, duration: 2h -->
...
<!-- chapter: maintaining-linux-systems-in-air-gapped-environments-optional, duration: 3h -->
