...
<!-- chapter: gdb-fundamentals, duration: 2h -->
* `GDB` Fundamentals
...
<!-- chapter: advanced-gdb-features, duration: 2h -->
...
<!-- chapter: lldb-and-alternative-debuggers, duration: 1h -->
...
<!-- chapter: static-analysis-tools, duration: 1h -->
...
<!-- chapter: memory-bug-categories, duration: 1h -->
...
<!-- chapter: valgrind-memory-debugging, duration: 1h -->
...
<!-- chapter: addresssanitizer-asan, duration: 1h -->
...
<!-- chapter: memory-debugging-techniques, duration: 1h -->
...
<!-- chapter: core-dump-analysis, duration: 2h -->
* Core Dump Analysis
...
<!-- chapter: multi-threading-bugs, duration: 2h -->
...
<!-- chapter: thread-debugging-with-gdb, duration: 1h -->
...
<!-- chapter: threadsanitizer-tsan, duration: 2h -->
...
<!-- chapter: helgrind-and-drd, duration: 1h -->
* Helgrind and DRD
...
<!-- chapter: advanced-synchronization-debugging, duration: 2h -->
...
<!-- chapter: understanding-heisenbugs, duration: 1h -->
...
<!-- chapter: reproducing-non-deterministic-bugs, duration: 2h -->
...
<!-- chapter: race-condition-hunting, duration: 2h -->
...
<!-- chapter: dynamic-binary-instrumentation, duration: 1h -->
...
<!-- chapter: system-level-debugging, duration: 2h -->
...
<!-- chapter: debugging-best-practices, duration: 2h -->
...
<!-- chapter: post-mortem-and-failure-analysis, duration: 3h -->
