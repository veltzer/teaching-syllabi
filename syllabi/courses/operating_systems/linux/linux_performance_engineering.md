...
<!-- chapter: profiling-and-tracing-tools, duration: 3h -->
...
<!-- chapter: disk-and-file-system-performance, duration: 3h -->
...
<!-- chapter: network-performance, duration: 3h -->
* Network performance
...
<!-- chapter: application-level-optimization, duration: 3h -->
...
<!-- chapter: continuous-performance-engineering, duration: 2h -->
