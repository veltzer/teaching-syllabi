...
## Description
This short course is about the `Linux` `device tree`, what is it for and how to manipulate it with the
object of providing board support or tuning your kernel to a specific purpose.
...
## Outline
<!-- chapter: why-the-device-tree, duration: 1h -->
* Why the `Device Tree` ?
<!-- chapter: basic-device-tree-syntax, duration: 1h -->
* Basic `Device Tree` syntax
<!-- chapter: device-tree-inheritance, duration: 1h -->
* `Device Tree` inheritance
<!-- chapter: device-tree-specifications-and-bindings, duration: 1h -->
* `Device Tree` specifications and bindings
<!-- chapter: device-tree-and-linux-kernel-drivers, duration: 1h -->
* `Device Tree` and `Linux` kernel drivers
<!-- chapter: common-properties-and-examples, duration: 3h -->
