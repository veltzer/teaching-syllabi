...
## Outline
<!-- chapter: android-overview, duration: 6h -->
* `Android` Overview
    * `Android` history
    * `Android` stack
...
<!-- chapter: android-user-space-native-layer, duration: 4h -->
...
<!-- chapter: android-application-framework-layer, duration: 3h -->
...
<!-- chapter: inter-process-communication-ipc-with-android-binder-and-aidl, duration: 3h -->
...
<!-- chapter: android-security, duration: 5h -->
* `Android` Security
...
<!-- chapter: android-startup, duration: 4h -->
* `Android` Startup
...
<!-- chapter: customizing-android, duration: 8h -->
* Customizing `Android`
