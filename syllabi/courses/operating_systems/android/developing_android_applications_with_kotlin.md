...
duration_hours: 56
---
<!-- course: developing_android_applications_with_kotlin -->
...
## Outline
<!-- chapter: kotlin-programming-long, duration: 3h -->
...
* The Development Environment
    ...
    * Running our project
<!-- chapter: use-of-kotlin-in-android, duration: 3h -->
...
<!-- chapter: ui-layouts-and-views-in-kotlin, duration: 2h -->
...
<!-- chapter: beyond-kotlin, duration: 5h -->
* Beyond `Kotlin`
