...
<!-- chapter: exploring-your-android-device, duration: 1h -->
...
<!-- chapter: the-java-layer-basics-assumes-knowledge-of-java, duration: 2h -->
...
<!-- chapter: the-java-layer-advanced, duration: 2h -->
* The `Java` layer (advanced)
    ...
    * managing data storage.
        * files.
        * database like.
<!-- chapter: jni-interlude-assumes-knowledge-of-linux-native-development, duration: 2h -->
...
<!-- chapter: the-ndk-basics, duration: 1h -->
* The `NDK` (basics)
...
<!-- chapter: the-ndk-advanced, duration: 3h -->
* The `NDK` (advanced)
    ...
    * interprocess communication mechanisms.
<!-- chapter: the-android-kernel-assumes-knowledge-of-the-linux-kernel, duration: 1h -->
* The `android` kernel: assumes knowledge of the `Linux` kernel
    * difference between `android` and stock `Linux` kernel.
        ...
        * kernel debugger.
        * logger.
<!-- chapter: writing-kernel-modules-for-android, duration: 2h -->
...
<!-- chapter: the-boot-process, duration: 1h -->
* The boot process
