...
* Database Security and User Management
    ...
    * Auditing and database security policies
    * Virtual private databases (VPD) and data encryption
<!-- chapter: backup-and-recovery, duration: 6h -->
* Backup and Recovery
    * Backup strategies and types (full, incremental, archive logs)
    * Configuring and managing Recovery Manager (RMAN)
    * Performing backup and restore operations
    * Media management and retention policies
    * Database recovery and point-in-time recovery
<!-- chapter: database-performance-monitoring-and-tuning, duration: 6h -->
* Database Performance Monitoring and Tuning
    * Performance monitoring tools (AWR, ASH, `SQL` Tuning Advisor)
    * Analyzing and resolving performance bottlenecks
    * `SQL` tuning and optimizer statistics
    * Memory management and configuration
    * Indexing strategies and partitioning techniques
<!-- chapter: advanced-database-administration, duration: 6h -->
* Advanced Database Administration
    * Automating administrative tasks using scripts and tools
    * Database upgrades and patching
    * Resource Manager and Database Resource Manager
    * Database replication and data transfer
    * High availability and failover solutions (RAC, Data Guard)
<!-- chapter: troubleshooting-and-maintenance, duration: 8h -->
