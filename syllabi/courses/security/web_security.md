...
## Outline
<!-- chapter: introduction-to-web-security-landscape, duration: 1h -->
...
<!-- chapter: authentication-and-authorization-fundamentals, duration: 1h -->
...
<!-- chapter: jwt-json-web-tokens-deep-dive, duration: 1h -->
...
<!-- chapter: modern-authentication-protocols, duration: 1h -->
...
<!-- chapter: encryption-and-cryptography-for-web-applications, duration: 1h -->
...
<!-- chapter: common-web-vulnerabilities-and-prevention, duration: 1h -->
...
<!-- chapter: secure-api-design-and-implementation, duration: 1h -->
...
<!-- chapter: security-testing-and-monitoring, duration: 1h -->
