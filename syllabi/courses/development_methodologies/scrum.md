...
* The Team
    ...
    * T-shaped people
<!-- chapter: product-backlog-and-user-stories, duration: 2h -->
* Product Backlog and User Stories
    * Product backlog characteristics
    * User Stories
    * Getting your first backlog
<!-- chapter: estimation, duration: 2h -->
* Estimation
    * Why comparative estimation works
    * Planning Poker
<!-- chapter: product-backlog-items, duration: 2h -->
* Product Backlog Items
    * Getting backlog items Ready
    * Slicing User stories
<!-- chapter: sprint-planning, duration: 2h -->
* Sprint Planning
    * Team capacity
    * Facilitating the sprint planning meeting
    * The Sprint backlog
    * Sprint Burndown chart
<!-- chapter: the-sprint, duration: 2h -->
* The Sprint
    * Definition of Done
