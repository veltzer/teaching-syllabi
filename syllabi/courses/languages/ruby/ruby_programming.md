...
* Collections
    ...
    * Hashes: creation, access, and manipulation
    * Ranges
    * Iterators (each, map, select, reject, reduce)
    * Enumerable module
<!-- chapter: methods-and-blocks, duration: 3h -->
* Methods and Blocks
...
<!-- chapter: modules-and-mixins, duration: 2h -->
* Modules and Mixins
    * Defining modules
...
* Regular Expressions
    ...
    * Match data and captures
    * String methods with regex (scan, gsub, match)
...
* `File` `I/O`
    ...
    * IO streams and buffering
<!-- chapter: gems-and-bundler, duration: 2h -->
* Gems and Bundler
...
* Metaprogramming
    ...
    * define_method and dynamic method creation
...
<!-- chapter: ruby-on-rails-introduction, duration: 2h -->
...
* Ruby Best Practices
    ...
    * Tools for code quality (RuboCop, Reek)
