...
---
# Microservices with `Spring Boot` and `Spring Cloud` (shortened)
...
world. Course participants will learn how to leverage `Spring` to develop Microservices and `REST`
architectures, and will strengthen this knowledge using hands-on exercises with `Spring MVC`, `Spring`
Boot, and `Spring Cloud`.

This is a shortened version of the course to a single day instead of two days:
* exercises were removed
* testing chapter was removed
...
## Objectives
* understand the core concepts and principles of Microservices with `Spring Boot` and `Spring Cloud` (shortened)
* gain practical knowledge of Refresher: Introduction to the `Spring` Framework
* gain practical knowledge of Introduction to `Spring MVC
* gain practical knowledge of Spring Boot
