...
## Outline
<!-- chapter: parallel-computing-introduction, duration: 1h -->
...
<!-- chapter: introduction-to-opencl, duration: 1h -->
* Introduction to `OpenCL`
    * What is `OpenCL`
    * How `OpenCL` came to be
    * `OpenCL` models
<!-- chapter: first-code-the-anatomy-of-opencl-applications, duration: 4h -->
* First code - The anatomy of `OpenCL` applications
    ...
    * The execution model
        ...
        * Cleanup
<!-- chapter: platforms-and-devices, duration: 1h -->
...
<!-- chapter: data-parallelism-and-some-complimentary-information, duration: 4h -->
...
<!-- chapter: opencl-images, duration: 3h -->
* `OpenCL` images
    * What are images
