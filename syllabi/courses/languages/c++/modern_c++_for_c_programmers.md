...
## Outline
<!-- chapter: c-refresher, duration: 2h -->
* `C++` Refresher
    ...
    * Inheritance
    * Polymorphism
<!-- chapter: robust-design, duration: 2h -->
* Robust Design
    ...
    * Coding Style
    * `C++` 11 game-changers
<!-- chapter: const-copying-and-conversions, duration: 2h -->
...
* Move and Forward
    ...
    * Perfect forwarding
<!-- chapter: strong-primitive-types, duration: 1h -->
...
<!-- chapter: operator-overloading, duration: 2h -->
* Operator Overloading
    ...
    * Namespaces
<!-- chapter: portable-integers-and-robust-constructors, duration: 2h -->
...
<!-- chapter: bitfields-and-unions, duration: 2h -->
* Bitfields and Unions
    ...
    * Type Traits
    * Static_Assert
<!-- chapter: delegation-techniques, duration: 3h -->
* Delegation Techniques
    ...
    * Interface Classes
    * Nested Classes
<!-- chapter: statics-and-globals, duration: 3h -->
* Statics and Globals
    * Storage Class
...
<!-- chapter: volatile-variables, duration: 2h -->
* Volatile Variables
    * Memory Mapped IO
    * Volatile
    * Placement New
...
<!-- chapter: multithreading-techniques, duration: 3h -->
...
* Polymorphism
    ...
    * Downcasting
<!-- chapter: safe-association, duration: 2h -->
* Safe Association
...
<!-- chapter: design-patterns, duration: 3h -->
* `Design Patterns`
    * Composite
    * Cheshire Cat
    * Bridge
...
<!-- chapter: functional-abstraction, duration: 2h -->
...
<!-- chapter: containers, duration: 2h -->
* Containers
