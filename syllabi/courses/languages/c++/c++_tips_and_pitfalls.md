...
## Outline
<!-- chapter: what-s-going-in-ctor-dtor-the-look-from-compiler-point-of-view, duration: 1h -->
...
<!-- chapter: operators-and-operator-overloading, duration: 3h -->
...
<!-- chapter: pointers-to-member-functions, duration: 1h -->
* Pointers to member-functions
    * How to declare and to use
    * How to save a lot of code
<!-- chapter: run-time-type-identification-rtti, duration: 1h -->
* Run Time Type Identification (RTTI)
<!-- chapter: stl-standard-template-library, duration: 2h -->
* `STL` - Standard Template Library:
    * Containers
    * Algorithms
    * auto_ptr
    * locale
<!-- chapter: c-standard-i-o-library-streams, duration: 1h -->
...
<!-- chapter: code-optimization, duration: 1h -->
* Code Optimization
    * Trivial optimizations
    * Object size
<!-- chapter: coding-rules-and-naming-conventions, duration: 3h -->
