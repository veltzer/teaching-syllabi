...
* `Python` refresher (2 hours)
    ...
    * `Python` iterators
    * type() vs isinstance()
<!-- chapter: idiomatic-python, duration: 3h -->
* Idiomatic `Python` (2 hours)
    ...
    * Correct use of basic libraries
        * collections
<!-- chapter: memory-and-garbage-collector, duration: 3h -->
...
<!-- chapter: object-oriented-python-toolkit, duration: 5h -->
* Object Oriented `Python` toolkit (4 hours)
    ...
    * Modules
<!-- chapter: functional-python, duration: 3h -->
...
<!-- chapter: debugging-linting-and-testing-your-python-code, duration: 2h -->
...
<!-- chapter: async-python, duration: 3h -->
...
<!-- chapter: python-s-with-statement, duration: 1h -->
* `Python`'s `with-statement` (2 hours)
    * How to use it
    * How to write your own resource
    * `When` should you use it
<!-- chapter: python-meta-classes, duration: 2h -->
...
<!-- chapter: logging-in-python, duration: 3h -->
...
* Memory mappings and large data structures in `Python` (2 hours)
    ...
    * `lmdb`
    * `numpy`.memmap
<!-- chapter: porting-from-python2-to-python3, duration: 2h -->
* Porting from Python2 to Python3 (2 hours)
    * Most notable changes
    * the __future__ module
    * Using the six module
    * Doing it the `agile` way
<!-- chapter: python-descriptors, duration: 2h -->
...
<!-- chapter: python-multi-threading-and-multi-processing, duration: 4h -->
