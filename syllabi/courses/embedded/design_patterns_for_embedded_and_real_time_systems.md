...
* Implementing Object Oriented Concepts with `C`
    ...
    * Inheritance
    * Polymorphism
<!-- chapter: memory-management-advance-techniques, duration: 3h -->
...
<!-- chapter: object-patterns, duration: 2h -->
* Object Patterns
    * Manager pattern
    * Resource Management Patterns
    * Message Handler
    * Observers and Publish - Subscribe Patterns
<!-- chapter: state-machines-patterns, duration: 2h -->
* State Machines Patterns
    * State Pattern
    * Serial and parallel wait state Patterns
    * Hierarchical Pattern
<!-- chapter: concurrency-patterns, duration: 5h -->
...
* Protocols and Architectures Patterns
    ...
    * Microkernel pattern
    * Virtual machines
<!-- chapter: appendixes, duration: 2h -->
* Appendixes
    * Effective `STL`
    * `UML`
