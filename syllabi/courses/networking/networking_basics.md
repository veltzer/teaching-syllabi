...
## Outline
<!-- chapter: introduction-to-computer-networking, duration: 1h -->
...
<!-- chapter: osi-model-and-protocol-layers, duration: 2h -->
...
<!-- chapter: tcp-and-udp-transport-protocols, duration: 2h -->
...
<!-- chapter: http-protocol-deep-dive, duration: 2h -->
...
<!-- chapter: http-headers-and-request-response-details, duration: 2h -->
...
<!-- chapter: cookies-and-session-management, duration: 2h -->
...
<!-- chapter: dns-and-domain-name-resolution, duration: 2h -->
